...
.page-link:focus{
    box-shadow: 0 0 0 0.25rem #0143a340 !important;
}
...
.plan-card{
    border-bottom: 3px solid #0143a3;
}

.service-card__icon {
    background-color: #0143a326 !important;
}
.feature-card .icon {
    background-color: #0143a326 !important;
}
...
.custom--accordion .accordion-button {
    background-color: #0143a30d;
}

.overview-card__icon i {
    background: #0143a3;
    background: -webkit-linear-gradient(-103deg, #0143a3 0%, #0143a3 35%, #0143a3 76%, #0143a3 100%);
    background: linear-gradient(-103deg, #0143a3 0%, #0143a3 35%, #0143a3 76%, #0143a3 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
}

.section--bg {
    background-color: #0143a312;
}
