...
.custom--table, .custom--table tbody tr {
    background: #0143a3 !important;
}
...
.page-link:focus{
    box-shadow: 0 0 0 0.25rem #6fb95040 !important;
}
...
.plan-card{
    border-bottom: 3px solid #6fb950;
}

.service-card__icon {
    background-color: #6fb95026 !important;
}
.feature-card .icon {
    background-color: #6fb95026 !important;
}
...
.custom--accordion .accordion-button {
    background-color: #6fb9500d;
}

.overview-card__icon i {
    background: #6fb950;
    background: -webkit-linear-gradient(-103deg, #6fb950 0%, #6fb950 35%, #6fb950 76%, #6fb950 100%);
    background: linear-gradient(-103deg, #6fb950 0%, #6fb950 35%, #6fb950 76%, #6fb950 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
}

.section--bg {
    background-color: #6fb95012;
}
...
.account-form .form--control, .account-form .select {
    background-color: #0143a3ef;
}

.subscribe-section{
    background-color: #0143a3f7;
}