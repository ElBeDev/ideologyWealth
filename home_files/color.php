...
.page-link:focus{
    box-shadow: 0 0 0 0.25rem #d4af3740 !important;
}
...
.overview-card__icon i {
    background: #d4af37;
    background: -webkit-linear-gradient(-103deg, #d4af37 0%, #d4af37 35%, #d4af37 76%, #d4af37 100%);
    background: linear-gradient(-103deg, #d4af37 0%, #d4af37 35%, #d4af37 76%, #d4af37 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
}

.section--bg {
    background-color: #d4af3712;
}
