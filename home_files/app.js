...
try {
  ...
  console.debug('Testimonial slider not initialized (element not found)');
}
...
try {
  ...
  console.log('Brand slider not initialized (element not found)');
}

try {
  if ($('.story-main-slider').length > 0 && $('.story-nav-slider').length > 0) {
  ...
  console.log('Story sliders not initialized (elements not found)');
}