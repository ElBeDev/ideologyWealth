...
.page-link:focus{
    box-shadow: 0 0 0 0.25rem #83af4040 !important;
}
...
.plan-card{
    border-bottom: 3px solid #83af40;
}

.service-card__icon {
    background-color: #83af4026 !important;
}
.feature-card .icon {
    background-color: #83af4026 !important;
}
...
.custom--accordion .accordion-button {
    background-color: #83af400d;
}

.overview-card__icon i {
    background: #83af40;
    background: -webkit-linear-gradient(-103deg, #83af40 0%, #83af40 35%, #83af40 76%, #83af40 100%);
    background: linear-gradient(-103deg, #83af40 0%, #83af40 35%, #83af40 76%, #83af40 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
}

.section--bg {
    background-color: #83af4012;
}
